                ...
                <div class="col-span-1 grid grid-cols-1 gap-6 md:col-span-2 md:grid-cols-2">
                    ...
                    <div>
                        <label class="mb-1 block text-sm font-medium text-gray-700" for="land-area">
                            Area Lahan <span class="text-red-600">*</span>
                        </label>
                        <input
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option value="Afdeling 1" @selected($prunning->land->land_location == 'Afdeling 1')>Afdeling 1</option>
                            <option value="Afdeling 2" @selected($prunning->land->land_location == 'Afdeling 2')>Afdeling 2</option>
                            <option value="Afdeling 3" @selected($prunning->land->land_location == 'Afdeling 3')>Afdeling 3</option>
                            <option value="Afdeling 4" @selected($prunning->land->land_location == 'Afdeling 4')>Afdeling 4</option>
                            <option value="Afdeling 5" @selected($prunning->land->land_location == 'Afdeling 5')>Afdeling 5</option>
                        </select>
                        @error('land_location')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
