...
@section('content')
    <div class="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="rounded-lg bg-white p-6 shadow-md">
            ...
            <div class="mt-4">
                <a class="text-sm font-medium text-yellow-600 hover:text-yellow-800"
                    href="#">View all customers</a>
            </div>
        </div>
    ...
    <div class="mb-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="rounded-lg bg-white p-6 shadow-md">
            ...
            <div class="mt-4">
                <a class="text-sm font-medium text-green-600 hover:text-green-800"
                    href="#">View all customers</a>
            </div>
        </div>
    </div>
